...
{
  % Set the background template just for this frame
  ...
  \begin{frame}
    ...
    \end{centering}
  \end{frame}
  % Reset background to default after this frame
  \setbeamertemplate{background}{}%
}
% Make this frame appear at the beginning of each section
\AtBeginSection{\sectionpage}

\newcommand{\CustomTOC}{
  % Set background just for this frame
  \setbeamertemplate{background}{\color{orange!20}\rule{\paperwidth}{\paperheight}}%
  ...
  \begin{frame}[plain] % plain removes headers/footers for clean look
    ...
    % Red left-aligned bullets with spacing
