...
\setbeamertemplate{section page}
{
  ...
  \begin{frame}
    \begin{centering}
      \vfill
      {\large\bfseries Део \thesection} \\[3em]
      % Full-width rectangle with centered text
      \begin{tikzpicture}[remember picture,overlay]
        % Define rectangle coordinates
        \coordinate (left)  at (current page.west |- 0,0);
        \coordinate (right) at (current page.east |- 0,1cm); % rectangle height 1cm
        % Draw rectangle
        \fill[craneColor] (left) rectangle (right);
        % Place text centered inside the rectangle
        \node[anchor=center] at ($0.5*(left)+0.5*(right)$) {\Large\insertsectionhead};
      \end{tikzpicture}
      \vfill
    \end{centering}
  \end{frame}
...
\begin{frame}{Детаљи спектралне класификације}
  ...
  \begin{table}
    ...
    \resizebox{\textwidth}{!}{
      ...
      \hline
      \rowcolor{craneColor} \textbf{\textcolor{black}{Класа}} & \textbf{\textcolor{black}{Температура (K)}} & \textbf{\textcolor{black}{Боја}} & \textbf{\textcolor{black}{Маса ($M_\odot)$}} & \textbf{\textcolor{black}{\makecell{Водоничне линије \\ спектра}}} & \textbf{\textcolor{black}{\makecell[l]{Друге линије \\ спектра}}} & \textbf{\textcolor{black}{\makecell{Проценат \\ звезда}}} \\
      \hline
      \hline
