...
\begin{frame}{HR дијаграм нацртан коришћењем програма ”Mathematica”}
  \centering
  \vspace{0.5em}
  \only<1>{\fbox{\includegraphics[width=0.9\textwidth,height=0.80\textheight]{images/hr-regular.png}}}
  \only<2->{\fbox{\includegraphics[width=0.9\textwidth,height=0.80\textheight]{images/hr-final.png}}}
